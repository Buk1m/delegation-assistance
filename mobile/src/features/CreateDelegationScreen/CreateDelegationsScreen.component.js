...
import FieldRenderer from "../../components/Field/FieldRenderer.component"
        ...
        <View style={styles.container}>
            <ScrollView>
                <KeyboardAvoidingView behavior="padding" enable>
                    ...
                    <Field name="destinationCountryISO3" placeholder="Destination Country" component={FieldRenderer}
                           validate={[validator.required]} isSecure={false}/>

                    <Text style={styles.subtitle}> Destination Location </Text>
                    <Field name="destinationLocation" placeholder="Destination Location" component={FieldRenderer}
                           validate={[validator.required]} isSecure={false}/>

                    <Text style={styles.subtitle}> Delegation Objective</Text>
                    <Field name="delegationObjective" placeholder="Delegation Objective" component={FieldRenderer}
                           validate={[validator.required]} isSecure={false}/>

                    <Text style={styles.subtitle}> Start Date </Text>
                    <Field name="startDate" component={DatePickerRenderer} validate={[validator.required]}
                           isSecure={false}/>

                    <Text style={styles.subtitle}> End Date </Text>
                    <Field name="endDate" component={DatePickerRenderer} validate={[validator.required]}
                           isSecure={false}/>
...
export default reduxForm({
    ...
    onSubmitSuccess: (result, dispatch) => {dispatch(reset("create-delegation"))}
